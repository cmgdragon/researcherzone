								...
								},
								{
									...
									[
										...
										},
										{
											...
											validate : function () {
												editor.config.youtube_width = "auto";
												if (this.getValue()) {
													var width = this.getValue();

													if (!width.includes('%') || width > 100 || width < 0) {
														alert('The youtube width must be expressed in %. Cannot be greater than 100% or less than 0%');
														return false;
													}
												}
												else {
